...
const TechniciansList = ({ searchFilters, updateSearchFilters }) => {
  ...
  const TechnicianCard = ({ tech, isRecommended = false }) => (
    <div className="border border-black border-opacity-40 rounded-[15px] py-4 px-2" style={{ height: '205px' }}>
    ...
    <section className="bg-white px-8">
      ...
      <div className="mb-6">
        <div className='flex justify-between items-center'>
          <h2 className="font-roboto font-semibold text-[40px] leading-[100%] align-middle tracking-normal">
            HVAC Technicians in {searchFilters.city || 'Toronto'}
          </h2>
          <button 
            onClick={() => handleQuoteRequest('bulk')}
            className="w-52 h-10 flex items-center justify-center gap-2 bg-[#AF2638] text-white font-semibold rounded-md shadow hover:bg-red-700 transition-colors duration-200"
          >
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_39_695)">
                <path d="M12.041 0.257324V2.9297H14.7132L12.041 0.257324Z" fill="white"/>
        ...
        <div className="flex flex-wrap items-center gap-4 mb-4 mt-4">
          ...
          <div className="flex items-center gap-2">
            <input 
              ...
              className="rounded" 
            />
            <label htmlFor="verified" className="text-sm text-gray-600">Star Experts</label>
          </div>
          ...
          <div className="flex items-center gap-2">
            <input 
              ...
              className="rounded" 
            />
            <label htmlFor="business-verified" className="text-sm text-gray-600">Bureau Verified Experts</label>
          </div>
          ...
          <button 
            ...
            className="bg-[#AF2638] text-white px-4 py-2 rounded text-sm font-medium hover:bg-red-700 transition-colors"
          >
        ...
        {showAllFilters && (
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Emergency Service</label>
                <select 
              ...
              <div className="flex items-end">
                <button 
                  ...
                  className="w-full bg-gray-500 text-white px-3 py-1 rounded text-sm hover:bg-gray-600 transition-colors"
                >
                  Clear Filters
                </button>
              </div>
        ...
        {recommendedTechnicians.length > 0 && (
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-['Roboto'] font-medium text-[30px] leading-[100%] align-middle text-[#213A59]">
      ...
      <div className="px-4">
        ...
        {filteredTechnicians.length === 0 && (
          <div className="text-center py-12">
            ...
            <button 
              ...
              className="bg-[#AF2638] text-white px-6 py-2 rounded font-medium hover:bg-red-700 transition-colors"
            >
              Clear Filters
            </button>
          </div>
        ...
        {displayedTechnicians < filteredTechnicians.length && (
          <div className="text-center mt-8">
            <button 
              ...
              className="bg-red-600 text-white px-6 py-2 rounded font-medium hover:bg-red-700 transition-colors mb-3"
            >
        ...
        {selectedQuotes.size > 0 && (
          <div className="fixed bottom-4 right-4 bg-[#AF2638] text-white p-4 rounded-lg shadow-lg">
